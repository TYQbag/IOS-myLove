...
//            if ([[photo.photoURL absoluteString] hasPrefix:@"http"])
//            {
//                [_photoImageView setImageWithURL:photo.photoURL placeholderImage:[UIImage imageNamed:@"empty"] success:^(UIImage *image) {
//                [weakSelf displayImage];
...
//            }
//            else{
//                [_photoImageView setImageWithURL:photo.photoURL placeholderImage:[UIImage imageNamed:@"empty"]];
//                [weakSelf displayImage];
//            }
