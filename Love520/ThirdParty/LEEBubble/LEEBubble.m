...
@property (nonatomic , strong ) UILabel *timeLable;//文字视图
...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        _backgroundView.backgroundColor = [RGBCOLOR(BreakLine) colorWithAlphaComponent:0.8];
    
//        _backgroundView.lee_theme.LeeAddBackgroundColor(DAY,[RGBCOLOR(BreakLine) colorWithAlphaComponent:0.8])
//        .LeeAddBackgroundColor(NIGHT,[RGBCOLOR(MainNavColor) colorWithAlphaComponent:0.8]);
        ...
        _imageBackgroundView.backgroundColor = RGBCOLOR(MainNavColor);
//        
//        _imageBackgroundView.lee_theme.LeeAddBackgroundColor(DAY,RGBCOLOR(MainNavColor))
...
//        [self addSubview:_imageView];
        ...
        _timeLable = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 40, 24)];
        _timeLable.backgroundColor = [UIColor clearColor];
        _timeLable.text = [self getTimes:[DHE getGlobalVar:@"STARTTIME"]];
        _timeLable.textColor = [UIColor whiteColor];
        _timeLable.font  =[UIFont systemFontOfSize:13];
        _timeLable.center = CGPointMake(kBubbleWidth / 2 , kBubbleWidth / 2);
...
-(NSString *)getTimes:(NSString *)timeStringP{

    NSDateFormatter *dateFormatter = [[NSDateFormatter alloc] init];
    [dateFormatter setDateFormat: @"yyyy-MM-dd"];
    
    NSDate *benginDate= [dateFormatter dateFromString:timeStringP];

    NSTimeInterval times = [benginDate timeIntervalSinceNow];
    
    NSInteger day = -times/(24*60*60);
...
- (void)addAnimations{
    ...
    [self AddAniamtionLikeGameCenterBubbleWithView:_timeLable];
}
