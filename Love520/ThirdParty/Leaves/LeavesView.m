...
- (void) setUpLayers {
    ...
    _topPage.contentsScale = [[UIScreen mainScreen] scale];
    ...
    _topPageOverlay.contentsScale = [[UIScreen mainScreen] scale];
    ...
    _topPageShadow.contentsScale = [[UIScreen mainScreen] scale];
    _topPageReverse = [[CALayer alloc] init];
    _topPageReverse.contentsScale = [[UIScreen mainScreen] scale];
    ...
    _topPageReverseImage.contentsScale = [[UIScreen mainScreen] scale];
    ...
    _topPageReverseOverlay.contentsScale = [[UIScreen mainScreen] scale];
    ...
    _bottomPage.contentsScale = [[UIScreen mainScreen] scale];
